                ...
                if(data != null || data != undefined){
                    ...
                    for(var i = 0; i < data.length; i++){
                        if(data[i].status == 'examining'){
                            ...
                            html_patient_examining += '<td>' + (data[i].priority ? 'Có' : 'Không') + '</td>';
                           ...
                           html_patient_waiting += '<td>' + (data[i].priority ? 'Có' : 'Không') + '</td>';
                           ...
                           html_patient_waiting_test += '<td>' + (data[i].priority ? 'Có' : 'Không') + '</td>';
                          ...
                          html_patient_examined += '<td>' + (data[i].priority ? 'Có' : 'Không') + '</td>';
